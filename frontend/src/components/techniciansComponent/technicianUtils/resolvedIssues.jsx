...
const ResolvedAssignments = () => {
  ...
  const handleView = (assignmentId) => {
    // Navigate to the assignment details page with the assignmentId as a parameter
    navigate(`/technicians/dashboard/resolved-details/${assignmentId}`);
  };
  ...
  const filteredAssignments = assignments.filter(assignment => assignment.status === "resolved");
